 ...
 *
 * <p>
 * Kiwi's core domain is {@link io.jstach.kiwi.kvs.KeyValues}, which can be loaded using
 * the {@link io.jstach.kiwi.kvs.KeyValuesSystem}. This package provides the necessary
 ...
 * {@link io.jstach.kiwi.kvs.KeyValuesServiceProvider} interface, which allows for custom
 ...
 * <ul>
 * <li>{@link io.jstach.kiwi.kvs.KeyValuesSystem} - The main entry point for creating and
 * configuring loaders for key-value resources.</li>
 * <li>{@link io.jstach.kiwi.kvs.KeyValuesLoader} - Responsible for loading key-value
 * pairs from configured sources.</li>
 * <li>{@link io.jstach.kiwi.kvs.Variables} - A function that maps keys to values,
 * primarily used for variable interpolation during configuration loading.</li>
 * <li>{@link io.jstach.kiwi.kvs.KeyValuesResource} - Represents a resource containing
 * key-value pairs, with associated metadata for controlling the loading behavior.</li>
 * </ul>
 *
 * @see io.jstach.kiwi.kvs.KeyValuesSystem
 * @see io.jstach.kiwi.kvs.KeyValuesLoader
 * @see io.jstach.kiwi.kvs.Variables
 * @see io.jstach.kiwi.kvs.KeyValuesResource
 */
