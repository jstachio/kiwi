...
public interface KeyValuesServiceProvider {
	...
	public interface MediaFinder extends KeyValuesServiceProvider {
		...
		public Optional<KeyValuesMedia> findMedia(
				String mediaType);
	}

}
record DefaultLoaderContext(KeyValuesEnvironment environment, MediaFinder mediaFinder, Variables variables) implements LoaderContext {
