...
public interface Interpolator {
	...
	public static Interpolator create(
			Function<String, @Nullable String> f) {
	...
	public static class MissingVariableInterpolationException extends InterpolationException {
		...
		public MissingVariableInterpolationException(
				String message,
				String key,
				String raw,
				String variable) {
	...
	public String interpolate(
		...
		StrSubstitutor st = new StrSubstitutor(new StrLookup() {
			...
			public @Nullable String lookup(
				...
				if (v == null) {
					...
					throw new MissingVariableInterpolationException(
							"Variable is missing for key. key: '"
									+ key
									+ "'"
									+ ", variable: '"
									+ variable
		...
		try {
			...
			throw new InterpolationException(
					"Infinite recursion for key. key: '"
							+ key
							+ "', reason: '"
							+ e.getMessage()
							+ "'"
